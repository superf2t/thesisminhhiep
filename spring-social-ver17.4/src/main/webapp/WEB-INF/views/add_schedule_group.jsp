							...
							$.ajax({
								...
								success : function(data) {
									...
									if (data.success == true) {
										alert("Successfull!!!" + data.message);
							...
							<div class="col-lg-12">
								<div class="input-group">
									<input data-format="hh:mm:ss" type="text" class="form-control"
										name="myTime"></input> <span class="add-on input-group-btn">
										<button class="btn btn-default" type="button">Timer!</button> <i
