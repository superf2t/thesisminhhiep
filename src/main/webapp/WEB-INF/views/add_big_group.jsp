				...
				<form:form id="formAddBigGroup" modelAttribute="bigGroupFace"
					...
					<div class="col-lg-12">
						...
						<div class="form-group has-warning">
							<form:input path="nameBigGroupFace" placeholder="Name of group"
						...
						<div class="form-group has-error">
							<p class="btn btn-primary" style="width: 100%; padding: 20px 0px"
								role="button" id="postAddBigGroup">Add Group</p>
						</div>
									...
									<c:forEach var="bigGroupFace" items="${bigGroupFaces}">
										<tr>
											<td><a class="btn btn-primary"
												href="subDeleteBigGroupFace?id=<c:out value='${bigGroupFace.idBigGroupFace}' />">Delete</a></td>
											<td><img src="resources/images/group.png" width="50px"
												height="50px" /></td>
											<td><a
