<div id="st-container" class="st-container">
	<!-- 	
			...
			-->
	<nav class="st-menu st-effect-1" id="menu-1" style="background-color: #6281BF;">
		<h2  style="color: white;" ><span class="glyphicon glyphicon-th-large"></span> Management</h2>
		<ul>
			<li><a  href="<%=request.getContextPath() %>/home"><span class="glyphicon glyphicon-home"></span> Home</a></li>
			<li><a  href="optionGroup"><span class="glyphicon glyphicon-ok"></span> Option Group</a></li>
			<li><a  href="schedule"><span class="glyphicon glyphicon-envelope"></span> Create Schedule</a></li>
			<li><a  href="addBigGroup"><span class="glyphicon glyphicon-list-alt"></span> Create BigGroup</a></li>
			<li><a  href="intruduce"><span class="glyphicon glyphicon-envelope"></span> Intruduce</a></li>
			...
			<div class="st-content-inner">
				...
				<div class="main clearfix">
					<div id="st-trigger-effects" class="column">
						<button
							style="position: fixed; z-index: 1000000; top: 0px; left: 0px;"
						...
						<!-- 							<button data-effect="st-effect-tton data-effect="st-effect-1">Slide in on top</button> -->
						<!-- 							<button data8">3D rotate out</button> -->
						...
						<!-- 							<button style="position: absolute; z-index: 1" data-effect="st-effect-14">Delayed 3D Rotate</button> -->
					</div>
